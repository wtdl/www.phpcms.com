...
$parentid = $menu_db->insert(array('name'=>'course', 'parentid'=>29, 'm'=>'course', 'c'=>'admin_course', 'a'=>'index', 'data'=>'', 'listorder'=>0, 'display'=>'1'), true);
...
$menu_db->insert(array('name'=>'course_load', 'parentid'=>$parentid, 'm'=>'course', 'c'=>'admin_course', 'a'=>'load', 'data'=>'s=2', 'listorder'=>0, 'display'=>'1'));
